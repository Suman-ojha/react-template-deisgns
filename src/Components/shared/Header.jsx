...
import { Menu, Popover, Transition, PopoverButton, PopoverPanel,MenuItem ,MenuItems} from '@headlessui/react'
const Header = () => {
                        ...
                        <>
                            <PopoverButton
                                className={classNames(
                                    open && 'bg-gray-100',
                                    'group  items-center rounded-sm p-1.5 text-gray-700 hover:text-opacity-100 focus:outline-none active:bg-gray-100'
                                )}
                            >
					...
					<div>
						<Menu.Button className="ml-2 bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-neutral-400">
							...
							<div
								...
								style={{ backgroundImage: 'url("https://ashallendesign.ams3.cdn.digitaloceanspaces.com/rMbsGOyK6i1KjNkbXff8qLohzM1nWQA8HNGwHF0J.png")' }}
							>
